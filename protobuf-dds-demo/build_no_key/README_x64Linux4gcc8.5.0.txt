...
> make -f makefile_ShapeType_x64Linux4gcc8.5.0 DEBUG=1
...
> objs/x64Linux4gcc8.5.0/ShapeType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc8.5.0/ShapeType_subscriber -d <domain_id> -s <sample_count>
