...
data type ShapeType from ShapeType_Key.idl.
This example builds two applications, named ShapeType_Key_publisher and
ShapeType_Key_subscriber.
...
> make -f makefile_ShapeType_Key_x64Linux4gcc8.5.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_ShapeType_Key_x64Linux4gcc8.5.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the ShapeType_Key_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc8.5.0/ShapeType_Key_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc8.5.0/ShapeType_Key_subscriber -d <domain_id> -s <sample_count>
